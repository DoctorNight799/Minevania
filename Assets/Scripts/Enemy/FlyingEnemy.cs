...
public class FlyingEnemy : MonoBehaviour
{
	...
	void FixedUpdate()
	{
		...
		if(timer_for_attack_true <= 0){
			...
			fly_enemy_see = Vector2.MoveTowards(transform.position, step, speed * Time.fixedDeltaTime);
		}
	...
	void attack()
	{
		...
		fly_enemy_see = Vector2.MoveTowards(transform.position, attack, speed * Time.fixedDeltaTime);
